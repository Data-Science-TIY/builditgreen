...
gulp.task('serve', shell.task(['python3 builditgreen/manage.py runserver']));
...
gulp.task('deploy', function() {
  return gulp.src('builditgreen/static/**/*').pipe(ghPages());
});
...
gulp.task('scss', function () {
  return gulp.src('./src/css/main.scss')
    ...
    .pipe(gulp.dest('builditgreen/static/css'));
});
...
gulp.task('js', function () {
  ...
  return stream
    ...
    .pipe(gulp.dest('builditgreen/static/js'));
});
