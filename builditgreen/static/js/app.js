            ...
            svg.selectAll("path")
                ...
                .on("mouseover", function(d) {
                    ...
                    div
                        ...
                        .text(function (d) {
                        console.log(d.properties.value);
                        return 'Projects ' + ': ' + d.properties.value;
                    })
...
},{"./buildgradient":6}],9:[function(require,module,exports){
module.exports = function() {
    ...
    var svg = d3.select(".intro-image").append("svg")
        .attr("width", width)
        .attr("height", height)
...
},{"d3":1,"jquery":"jquery","underscore":"underscore"}],13:[function(require,module,exports){
module.exports = function(domLocation) {
    var d3 = require('d3');
    var $ = require('jquery');
        ...
        d3.json(dataUrl[1], function(data1) {
            d3.json(dataUrl[2], function(data2) {
                ...
                var circles = svg.selectAll("circle")
                    ...
                    .style("fill", function(d) {
                        return color(d.certification_level);
                    })
                    .style("opacity", 1);
...
({"controllers":({"overview":require("./controllers/overview.js")})});

// Start the router
router.init();
},{"./controllers/overview.js":5,"./material.js":16,"./router":17}],16:[function(require,module,exports){
/**
...
},{"./sorted-router":18}],18:[function(require,module,exports){
'use strict';
...
},{"backbone":"backbone","underscore":"underscore"}]},{},[15])
